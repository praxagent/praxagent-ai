...
semantic similarity, that their meaning is very similar.
...
- **[aggarwal-surprising]** **<a id="ref-aggarwal-surprising"></a>Aggarwal, C. C., Hinneburg, A., & Keim, D. A. (2001).** *[On the Surprising Behavior of Distance Metrics in High Dimensional Space](https://bib.dbvis.de/uploadedFiles/155.pdf).* International Conference on Database Theory (ICDT).
...
- **[hubness-radovanovic]** **<a id="ref-hubness-radovanovic"></a>Radovanović, M., Nanopoulos, A., & Ivanović, M. (2010).** *[Hubs in space: Popular nearest neighbors in high-dimensional data](https://www.jmlr.org/papers/volume11/radovanovic10a/radovanovic10a.pdf).* Journal of Machine Learning Research (JMLR).
...
- **[splade-paper]** **<a id="ref-splade-paper"></a>Formal, T., et al. (2021).** *[SPLADE: Sparse Lexical and Expansion Model for First Stage Ranking](https://arxiv.org/abs/2107.05720).* Special Interest Group on Information Retrieval Conference (SIGIR).
...
- **[charikar-simhash]** **<a id="ref-charikar-simhash"></a>Charikar, M. S. (2002).** *[Similarity estimation techniques from rounding algorithms](https://dl.acm.org/doi/10.1145/509907.509965).* Symposium on Theory of Computing (STOC).
