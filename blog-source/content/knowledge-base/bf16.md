...
aliases:
  ...
  - /references/f16/
  - /references/f32/
  - /references/floating-point-formats/
---
...
called the mantissa. This page names three common data types (**dtypes**):
...
| **BF16** | 16 | 8 | 7 | Activations / [matmuls]({{< relref "matmul.md" >}}); FP32-like range, less precision |
...
See also: [matmul]({{< relref "matmul.md" >}}),
