...
That percentile is descriptive, not a significance level. Vocabulary entries are not exchangeable, and absolute rank is heavily affected by [base-rate bias]({{< relref "knowledge-base/glossary/base-rate-bias/index.md" >}}).

Notes often report [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}), the minimum over a pre-specified search grid. Compare pressure to a matched control and apply the identical statistic to [logit lens]({{< relref "knowledge-base/glossary/logit-lens/index.md" >}}) and [random-J]({{< relref "knowledge-base/glossary/random-j/index.md" >}}).

See also: [unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}}), [workspace]({{< relref "knowledge-base/glossary/workspace/index.md" >}}).
