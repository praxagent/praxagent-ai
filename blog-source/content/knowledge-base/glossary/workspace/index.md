...
3. compare the same statistic with the [logit lens]({{< relref "knowledge-base/glossary/logit-lens/index.md" >}}), [random-J]({{< relref "knowledge-base/glossary/random-j/index.md" >}}), and matched prompts; and
4. report the full trajectory or the prospectively defined [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}).
...
See also: [residual stream]({{< relref "knowledge-base/glossary/residual-stream/index.md" >}}), [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}).
