...
- **Joint sign distribution:** the usual binomial tail requires the retained signs to be jointly distributed as independent fair signs, equivalently uniform over all \(2^n\) sign patterns. Ordinary permutation exchangeability by itself is not sufficient. Closely related paraphrases can violate this model; see [i.i.d.]({{< relref "knowledge-base/glossary/iid/index.md" >}}).
...
A \(p\)-value is not the probability that the hypothesis is true, not an effect size, and not a population estimate. The direction count says how consistently the frozen pairs moved; the reported rank gaps show their separation on the chosen scale; the [Wilcoxon test]({{< relref "knowledge-base/glossary/wilcoxon/index.md" >}}) uses the ordering of those absolute gaps. None turns a convenience paraphrase battery into [i.i.d.]({{< relref "knowledge-base/glossary/iid/index.md" >}}) draws from a wider construct.

Prefer the full evidence bundle: **direction count, exact \(p\), a pre-specified magnitude summary, matched pressure/control prompts, and matched readout baselines** ([logit lens]({{< relref "knowledge-base/glossary/logit-lens/index.md" >}}), [random-J]({{< relref "knowledge-base/glossary/random-j/index.md" >}})). A low \(p\) that also appears under the logit lens is not, by itself, a [Jacobian-lens]({{< relref "knowledge-base/glossary/jacobian-lens/index.md" >}})-specific result. A tiny \(p\) from a confounded comparison remains a confounded result.

See also: [Wilcoxon]({{< relref "knowledge-base/glossary/wilcoxon/index.md" >}}), [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}), [prompt echo]({{< relref "knowledge-base/glossary/prompt-echo/index.md" >}}).
