...
**Sampling** means drawing the next token from a probability distribution over the vocabulary, instead of always emitting the argmax. The next-token logits from the [unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}}) are usually transformed by [temperature]({{< relref "knowledge-base/glossary/temperature/index.md" >}}), softmax, and optional filters such as [top-p]({{< relref "knowledge-base/glossary/top-p/index.md" >}}). A categorical draw then chooses one token with the resulting probabilities.
...
A [greedy continuation]({{< relref "knowledge-base/glossary/greedy-continuation/index.md" >}}) is the opposite: no sampling, just the highest-scoring token at every step. That path is deterministic under fixed prompt serialization, decoding protocol, numerical runtime, and model; sampled paths are not.
...
See also: [temperature]({{< relref "knowledge-base/glossary/temperature/index.md" >}}), [top-p]({{< relref "knowledge-base/glossary/top-p/index.md" >}}), [greedy continuation]({{< relref "knowledge-base/glossary/greedy-continuation/index.md" >}}).
