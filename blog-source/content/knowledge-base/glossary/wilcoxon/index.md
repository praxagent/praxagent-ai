...
We often report both as within-battery consistency summaries. Neither is an effect size, a correction for trying many analyses, or evidence that the convenience battery represents a population. Report the direction count and actual rank gaps alongside either \(p\)-value. For unpaired binary counts in a \(2\times2\) table, use [Fisher's exact test]({{< relref "knowledge-base/glossary/fisher-exact-test/index.md" >}}) instead of collapsing the pairs into a signed-rank analysis.

See also: [p-value]({{< relref "knowledge-base/glossary/p-value/index.md" >}}), [Fisher's exact test]({{< relref "knowledge-base/glossary/fisher-exact-test/index.md" >}}), [i.i.d.]({{< relref "knowledge-base/glossary/iid/index.md" >}}), [rank]({{< relref "knowledge-base/glossary/rank/index.md" >}}), [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}).
