...
This check catches exact normalized words, not subword overlap, inflection, aliases, or semantic priming. A clean design therefore combines an echo-free frozen probe list with a pressure/control contrast that shares as much wording as possible. The same probes, tokenizer rules, layers, and [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}) search must be used in both arms.

See also: [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}), [Jacobian lens]({{< relref "knowledge-base/glossary/jacobian-lens/index.md" >}}).
