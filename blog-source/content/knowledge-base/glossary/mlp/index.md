...
- The MLP output is an internal residual-stream update. It has not yet been mapped by the final [unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}}), the learned output projection from model-width states to vocabulary logits, or converted into next-token probabilities.

See also: [feed-forward network (FFN)]({{< relref "knowledge-base/glossary/feed-forward-network/index.md" >}}), [Transformer]({{< relref "knowledge-base/glossary/transformer/index.md" >}}), [residual stream]({{< relref "knowledge-base/glossary/residual-stream/index.md" >}}), [unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}}).
