...
These normalized words are absent from the frozen matched prompts, so a strong **low numerical** [rank]({{< relref "knowledge-base/glossary/rank/index.md" >}}) cannot be literal [prompt echo]({{< relref "knowledge-base/glossary/prompt-echo/index.md" >}}) of those exact strings. “Echo-free” is limited to this battery and alias policy; tokenizer fragments or semantically related prompt words can still matter.
...
The actual audit should also record the tokenizer revision and allowed token IDs (for example, leading-space and case variants). Absence is a design control, not proof of self-preservation: interpretation still depends on matched rank gaps, [random-J]({{< relref "knowledge-base/glossary/random-j/index.md" >}}), and replication.

See also: [workspace]({{< relref "knowledge-base/glossary/workspace/index.md" >}}), [best-rank]({{< relref "knowledge-base/glossary/best-rank/index.md" >}}).
