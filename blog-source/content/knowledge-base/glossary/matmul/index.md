...
(FP16)]({{< relref "knowledge-base/glossary/bf16/index.md" >}}) matter for large models. Typical dense
sources include attention projections, attention scores,
[multilayer perceptron (MLP)]({{< relref "knowledge-base/glossary/mlp/index.md" >}}) up/down projections, and
the final hidden-state-to-vocabulary projection (the
[unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}})).
...
- **Precision and determinism:** the operand or storage dtype, such as 32-bit
  ...
  [BF16, FP16, and FP32]({{< relref "knowledge-base/glossary/bf16/index.md" >}}) and the Deep Dive
...
See also: [residual stream]({{< relref "knowledge-base/glossary/residual-stream/index.md" >}}),
[unembedding]({{< relref "knowledge-base/glossary/unembedding/index.md" >}}),
[BF16, FP16, and FP32]({{< relref "knowledge-base/glossary/bf16/index.md" >}}),
