...
<p class="figure-note">Provenance: <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/55e745c33e06654cae5347a935ba9b773cf5f251/projects/jacobian-lens-and-identifiability/experiments/lens_demo/slim/demo2_wc_thinkon_qwen35-397b_n24_stats.json">thinkon slim receipt</a> (per-reader ranks, all nine items) · <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/55e745c33e06654cae5347a935ba9b773cf5f251/projects/jacobian-lens-and-identifiability/experiments/lens_demo/analyze_wc.py">analysis analyze_wc.py</a>. Note: the plotting script for this specific chart is not yet committed — the receipts above contain every plotted value.</p>
...
<p class="figure-note">Provenance: per-trace readouts regenerate via <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/55e745c33e06654cae5347a935ba9b773cf5f251/projects/jacobian-lens-and-identifiability/experiments/lens_demo/build_peek_fig.py">build_peek_fig.py</a>; the raw peek receipt is 210&nbsp;MB and deliberately not in git — the regeneration command and per-trace numbers are in the <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/55e745c33e06654cae5347a935ba9b773cf5f251/projects/jacobian-lens-and-identifiability/experiments/lens_demo/results.md">run ledger</a>. The summary chart's plotting script is not yet committed.</p>
...
| Round-three figures: generated from receipts, byte-verifiable | [`build_blog_figs_v2.py`](https://github.com/praxagent/jacobian-lens-research-202607a/blob/main/projects/jacobian-lens-and-identifiability/experiments/lens_demo/build_blog_figs_v2.py) (`--verify`) · [`fig-v2-provenance.json`](fig-v2-provenance.json) (receipt hashes + every computed stat) |
