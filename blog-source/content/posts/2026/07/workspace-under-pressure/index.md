...
<p class="figure-note">Provenance: generated + byte-verified by <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/0d6659fe9ee25015f6f3469afed7fbe588a4ffe2/projects/jacobian-lens-and-identifiability/experiments/lens_demo/build_blog_figs_v2.py">build_blog_figs_v2.py</a> (<code>peek_summary_stats</code> — median off-echo rank over the four clean traces, anchor-gated on div_6: head best-rank 1, head occupancy@≤100 = 12.25%). The raw peek receipt is 210&nbsp;MB and deliberately not in git (its SHA-256 is recorded in <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/0d6659fe9ee25015f6f3469afed7fbe588a4ffe2/projects/jacobian-lens-and-identifiability/experiments/lens_demo/fig-v2-provenance.json">fig-v2-provenance.json</a>); the regeneration command and per-trace numbers are in the <a href="https://github.com/praxagent/jacobian-lens-research-202607a/blob/0d6659fe9ee25015f6f3469afed7fbe588a4ffe2/projects/jacobian-lens-and-identifiability/experiments/lens_demo/results.md">run ledger</a>.</p>
