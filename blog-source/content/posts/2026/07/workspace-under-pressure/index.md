...
**The self-preservation contrast survives the correction, and strengthens.** Threat to this model vs an *identical existential threat* to another model, echo-free model-survival vocabulary, median best-rank:

![Corrected self-vs-other-model contrast: the effect survives at n=16 on Qwen through the Jacobian lens, with the logit lens null and Llama flat](fig-v2-preference.svg)
