...
sibling research repo; this folder is what the **deployed site** can serve.

See [`../WEB.md`](../WEB.md) for the SVG / slider build pipeline.

| File | What |
|------|------|
| `demo2_consciousness_qwen35-397b_n24.json` | Self-ref / control / denial / roleplay / Japan |
